(define (problem menu-ext3b)
  ...
  (:init
    ...
    (consecutiu dijous divendres)    (incompatible paellaval salmonplanxa)
  ...
  (:goal (and
    ...
    (assignat dimecres primer amanidarusa)
    (assignat dimecres segon polloroast)
    (assignat dijous primer paellaval)  ; Mandatory assignment (paella on Thursday)
    (assignat dijous segon lasanya)
    (assignat divendres primer pastamediterranea)
    (assignat divendres segon fabada)   ; Mandatory assignment (fabada on Friday)
  ))
)
