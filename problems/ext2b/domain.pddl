...
(:action assignar-primer
    ...
    :precondition (and (es_rol ?p primer) 
                      (not (utilitzat ?p))
                      (forall (?d_prev - dia ?p_prev - plat ?t - tipus)
                        (not (and (consecutiu ?d_prev ?d)
                                 (assignat ?d_prev primer ?p_prev)
                                 (es_tipus ?p_prev ?t)
                                 (es_tipus ?p ?t)))))
...
(:action assignar-segon
    ...
    :precondition (and (es_rol ?p segon) 
                      (not (utilitzat ?p))
                      (assignat ?d primer ?pp)
                      (not (incompatible ?pp ?p))
                      (forall (?d_prev - dia ?p_prev - plat ?t - tipus)
                        (not (and (consecutiu ?d_prev ?d)
                                 (assignat ?d_prev segon ?p_prev)
                                 (es_tipus ?p_prev ?t)
                                 (es_tipus ?p ?t)))))
